...
5   shadow c1           The colour for the top left of the shadow.
6   shadow c2           The colour for the top right of the shadow.
7   shadow c3           The colour for the bottom right of the shadow.
8   shadow c4           The colour for the bottom left of the shadow.        
...
//draw text shadow
draw_text_colour(xx+lengthdir_x(sh_len,sh_dir),yy+lengthdir_y(sh_len,sh_dir), str, argument3, argument4, argument5, argument6, argument9);

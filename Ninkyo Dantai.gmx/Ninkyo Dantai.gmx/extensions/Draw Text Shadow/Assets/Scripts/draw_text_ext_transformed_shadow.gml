///draw_text_ext_transformed_shadow(x, y, string, sep, w, xscale, yscale, angle, shadow length, shadow direction, shadow color, shadow alpha);
//@tehwave
...
draw_text_ext_transformed(xx+lengthdir_x(sh_len,sh_dir), yy+lengthdir_y(sh_len,sh_dir), str, sep, w, xscale, yscale, angle);

//draw text
draw_set_color(prev_col);
draw_set_alpha(prev_alpha);
draw_text_ext_transformed(xx, yy, str, sep, w, xscale, yscale, angle);

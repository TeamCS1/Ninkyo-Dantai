///draw_text_color_shadow(x, y, string, c1, c2, c3, c4, shadow length, shadow direction, shadow color, shadow alpha);
// @tehwave
...
3   c1                  The color for the top left of the shadow.
4   c2                  The color for the top right of the shadow.
5   c3                  The color for the bottom right of the shadow.
6   c4                  The color for the bottom left of the shadow.  

7   shadow length       The distance in pixels between text and shadow.      
8   shadow direction    The angle of the shadow.
9   shadow color       The color of the shadow.
10  shadow alpha        The alpha of the shadow.
*/

//init & assign vars
var xx = argument0, yy = argument1, str = argument2, sh_len = argument7,
    sh_dir = argument8, prev_alpha = draw_get_alpha(), prev_col = draw_get_color();
...
//draw text
draw_text_color(xx, yy, str, argument3, argument4, argument5, argument6,prev_alpha);
